# Design System Inspired by Huasheng

## 1. Visual Theme & Atmosphere

Huasheng's design system is a book rendered as a webpage — warm, spacious, and quietly authoritative. The entire experience is built on a pure white canvas (`#FFFFFF`) with a single accent color: Burnt Orange (`#C2410C`), used with discipline as the sole chromatic element across the entire system. Where most design systems rely on multiple accent colors, Huasheng commits to one — and that commitment creates an unmistakable identity.
...
What makes Huasheng distinctive is its radical restraint. No shadows anywhere (one micro-exception for QR codes). No gradients (one subtle warm gradient reserved for cover and back pages only). No rounded corners beyond 8px. The depth comes entirely from the interplay between the Burnt Orange accent, four tiers of gray text, and generous whitespace. Functional cards — tips (green), warnings (red), callouts (yellow) — provide semantic color, but the brand expression is always monochromatic orange on white.

**Key Characteristics:**
- Pure white canvas with Burnt Orange (`#C2410C`) as the sole accent color
...
- 3px Burnt Orange section dividers as the primary structural element
- Decorative cover lines: 80px orange + 30px light orange (`#FDBA74`) top-left corner
- Zero shadows, zero gradients (except cover/back page warm gradient)
- Section numbering with `§01` `§02` format in Inter font, Burnt Orange color
- Print-friendly: `page-break-inside: avoid` on all card components

## 2. Color Palette & Roles

### Primary
- **Burnt Orange** (`#C2410C`): The core and only accent color — used for section dividers, badges, step numbers, links, flow chart borders, and comparison headers. Deliberately warm and earthy.
...
### Surface & Background
- **Cover Gradient**: `linear-gradient(135deg, #FFFBF5 0%, #FFF5EB 25%, #FFFFFF 100%)` — an extremely subtle warm tint, used only on cover and back pages.
- **Accent Light** (`#FFF7ED`): Light orange tint for highlighted content blocks.
...
- **Section Line** (`#C2410C`): 3px top border on section headings — the primary structural accent.
- **Decorative Light Orange** (`#FDBA74`): Secondary cover decoration line.
...
| Section Heading (h2) | Noto Sans SC | 20pt | 700 | default | normal | 3px Burnt Orange top border |
| Section Number | Inter | 18pt | 700 | default | normal | `§01` format, Burnt Orange color |
...
- **Section numbering in Inter**: The `§01` format uses Inter bold in Burnt Orange — creating a typographic anchor that ties structure to brand.

## 4. Component Stylings

### Section Dividers
- 3px solid Burnt Orange (`#C2410C`) top border on every h2
- The primary visual rhythm element — every new section announces itself with an orange line

### Cover
- Background: subtle warm gradient
- Top-left decoration: two horizontal lines (80px orange + 30px light orange)
- Badge: Burnt Orange background, white text, 3px radius
- Title `<em>` renders in Burnt Orange for emphasis
...
- `<strong>` text renders in Burnt Orange

### Step Components
- Number: 26px circle, Burnt Orange background, white text, Inter font
- Horizontal layout (flexbox) with 12px gap
- `page-break-inside: avoid`

### Flow Charts
- Horizontal centered layout with flex-wrap
- Nodes: white background, 2px Burnt Orange border, 8px radius, Burnt Orange text
...
- Brand Accent: "Burnt Orange (#C2410C)"
- Page Background: "Pure White (#FFFFFF)"
- Primary Text: "Near Black (#1A1A1A)"
- Secondary Text: "Gray (#6B6B6B)"
- Tertiary Text: "Light Gray (#9CA3AF)"
- Section Divider: "3px solid #C2410C"
- Code Background: "Warm Gray (#F5F5F0)"
- Cover Gradient: "linear-gradient(135deg, #FFFBF5 0%, #FFF5EB 25%, #FFFFFF 100%)"

### Example Component Prompts
- "Create a cover page with warm gradient background, 80px+30px orange decoration lines top-left, title at 36pt weight 900, Burnt Orange badge, and vertically centered layout."
- "Create a section heading with 3px Burnt Orange top border, §01 numbering in Inter bold orange, 20pt Noto Sans SC weight 700, and optional italic English subtitle in #9CA3AF."
- "Create a tip card with #F0FDF4 background, 4px green left border, 8px right border-radius, and auto-generated label."
- "Create a price display with Inter font, 72px weight 800, Burnt Orange color, centered on white background with section divider above."
- "Create a step component with 26px Burnt Orange circle number, white text, Inter font, horizontal flex layout with 12px gap."
